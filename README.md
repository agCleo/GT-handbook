...
| Recommended | Language of the resource | Describes the language in which the resource is expressed. Like for keywords, best practice is to usethe ISO norms, for instance the [ISO 639-1](https://en.wikipedia.org/wiki/ISO_639-1) two-letters code. | 
