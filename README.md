...
| Recommended | Keywords  | Can contain one or many keywords describing the content of the resource. In DC, the keywords language can be specified using an `xml:lang` attribute. Best practice is to use the ISO norms, for instance the [ISO 639-1]([https://iso639-2.sil.org/](https://en.wikipedia.org/wiki/ISO_639-1) two-letters code to identify the language |
